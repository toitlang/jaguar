...
- [Download Jaguar for Windows](https://github.com/toitlang/jaguar/releases/download/v1.4.2/jag_installer.exe)
  (or as an [archive](https://github.com/toitlang/jaguar/releases/download/v1.4.2/jag_windows.zip))

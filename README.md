...
- [Download Jaguar for Windows](https://github.com/toitlang/jaguar/releases/download/v1.5.3/jag_installer.exe)
  (or as an [archive](https://github.com/toitlang/jaguar/releases/download/v1.5.3/jag_windows.zip))

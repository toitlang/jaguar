...
func TestParseLine(t *testing.T) {
	cases := []struct {
		...
		{`dbg:stack off=5 r0="hello world" r1=42`, Event{Kind: KindStack, Off: 5, Regs: map[int]string{0: `"hello world"`, 1: "42"}}},
		{`dbg:stack off=5 r0=<obj:Point> r1="a\"b\\c" r2=null`, Event{Kind: KindStack, Off: 5, Regs: map[int]string{0: "<obj:Point>", 1: `"a"b\c"`, 2: "null"}}},
		{`dbg:stack off=5 r0="tab\there" r1="r1=not a reg"`, Event{Kind: KindStack, Off: 5, Regs: map[int]string{0: "\"tab\there\"", 1: `"r1=not a reg"`}}},
		{`dbg:stack off=5 r0="ctrl\x01end"`, Event{Kind: KindStack, Off: 5, Regs: map[int]string{0: "\"ctrl\x01end\""}}},
